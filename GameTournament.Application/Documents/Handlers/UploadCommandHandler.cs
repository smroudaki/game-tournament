...
namespace GameTournament.Application.Documents.Handlers
{
    public class UploadCommandHandler : IRequestHandler<UploadCommand, UploadViewModel>
    {
        ...
        public UploadCommandHandler(IUnitOfWork unitOfWork,
        ...
        public async Task<UploadViewModel> Handle(UploadCommand request, CancellationToken cancellationToken)
        {
            ...
            switch (request.File.ContentType)
            {
                ...
                case "image/jpeg":
                    ...
                    break;
                default:
                    string[] errors = new string[] { "فرمت فایل ارسالی نامعتبر است" };
                    return UploadViewModel.Failure(errors);
            }
            ...
            return UploadViewModel.Success(document.DocumentGuid, document.Path);
        }
    }
}
