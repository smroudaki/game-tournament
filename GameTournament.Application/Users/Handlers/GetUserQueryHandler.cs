    ...
    public class GetUserQueryHandler : IRequestHandler<GetUserQuery, UserViewModel>
    {
        ...
        public async Task<UserViewModel> Handle(GetUserQuery request, CancellationToken cancellationToken)
        {
            ...
            var user = await _unitOfWork.Users
                .Get(u => u.UserGuid.Equals(request.UserGuid) && u.PhoneNumberConfirmed, null, "ProfileDocument,Province,UserIntroduced")
            ...
            if (user == null)
            {
                ...
                return new UserViewModel(false, errors);
            }
            ...
            return new UserViewModel(true, new string[] { }) { User = user };
        }
